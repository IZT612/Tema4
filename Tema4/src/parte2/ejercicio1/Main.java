...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Pedimos todos los datos y los vamos guardando en las variables correspondientes
		...
		// Creamos el objeto cuenta1 llamando al constructor correspondiente pasando todos los datos necesarios
		...
		// Comprobamos si las cuentas son iguales con el metodo del objeto "equals" e informamos al usuario segun el caso
		...
		// Según lo que obtengamos con la funcion "ingresarDinero" mostramos un mensaje u otro
		...
		// Según lo obtenido llamando al metodo del objeto "sacarDinero" mostramos un mensaje u otro
