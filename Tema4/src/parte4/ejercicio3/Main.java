 ...
 * Este programa permite al usuario interactuar con una fecha, pudiendo
 * ver la fecha, comprobar si el año es bisiesto, verificar si la fecha es correcta
...
public class Main {
     ...
     * Solicita al usuario que introduzca una fecha y permite realizar
     * operaciones como ver la fecha, comprobar si el año es bisiesto,
     * verificar si la fecha es correcta y avanzar al día siguiente.
     */
